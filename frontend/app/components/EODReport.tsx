...
const liveUpdates = [
  {
    time: '16:00 EST',
    update: 'Market closes with mixed results. S&P 500 and Dow Jones post gains while NASDAQ sees slight decline.',
    source: 'WSJ Market Summary',
  },
  {
    time: '15:45 EST',
    update: 'Tech stocks showing late-day volatility. NVIDIA leads gains with strong earnings outlook.',
    source: 'WSJ Tech Section',
  },
  {
    time: '15:30 EST',
    update: 'Energy sector dips on crude oil price concerns. WTI crude down 1.2% for the day.',
    source: 'WSJ Markets',
  },
  {
    time: '15:00 EST',
    update: 'Federal Reserve comments on interest rates boost financial sector confidence.',
    source: 'WSJ Economic News',
  },
];
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                        <span className="text-blue-600 font-semibold text-sm">{update.time.split(':')[0]}:{update.time.split(':')[1].split(' ')[0]}</span>
                      </div>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <div className="text-sm font-medium text-gray-500">{update.time}</div>
